      ...
      <div className='min-h-screen bg-slate-50 text-slate-800'>
        ...
        <section className='mx-auto max-w-4xl px-4 py-4'>
          ...
          <div className='mt-3 flex flex-wrap gap-2'>
            {skills.map(s => (
              <span key={s} className='rounded-full border border-slate-200/70 px-3 py-1 text-sm'>
                {s}
              </span>
            ))}
          </div>
        ...
        <section className='mx-auto max-w-4xl px-4 py-8'>
          ...
          <div className='mt-4 space-y-6'>
            {experience.map((item, idx) => (
              <article key={idx} className='rounded-2xl border border-slate-200/70 bg-white p-4 shadow-sm'>
        ...
        <section className='mx-auto max-w-4xl px-4 pb-16'>
          ...
          <div className='mt-4 grid gap-4 sm:grid-cols-2'>
            {education.map((e, i) => (
              <div key={i} className='rounded-2xl border border-slate-200/70 bg-white p-4'>
        ...
        <footer className='border-t border-slate-200/70 bg-white/60 py-6 text-sm text-slate-500 backdrop-blur'>
