    ...
    experience: [
      {
        ...
        bullets: [
          'Bidrager i teamet til prioritering af roadmap, backlog, opgraderinger, testforløb, datakvalitet og kvalitetssikring for studieadministrative systemer.',
    ...
    experience: [
      {
        ...
        bullets: [
          'Contribute within the team to prioritizing roadmap, backlog, upgrades, test tracks, data quality and quality assurance for student administration systems.',
